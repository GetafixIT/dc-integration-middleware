import SalesforceD2CCommerceCodecTypeType, { SalesforceD2CCommerceCodecType } from '.'
...
describe('sfcc integration', function() {
	let sfccCodec: SalesforceD2CCommerceCodecType
	...
	beforeEach(async () => {
		...
		sfccCodec = new SalesforceD2CCommerceCodecType(flattenConfig(config))
		await sfccCodec.init(new SalesforceD2CCommerceCodecTypeType())
	})
